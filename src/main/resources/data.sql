...
REPLACE INTO diagnos(id, description, name) VALUES (1,'descriprion1', 'diagnos1');
REPLACE INTO diagnos(id, description, name) VALUES (2,'descriprion2', 'diagnos2');
REPLACE INTO diagnos(id, description, name) VALUES (3,'descriprion3', 'diagnos3');
...
REPLACE INTO treatment_diagnos(id, diagnos_id) VALUES (1,3);
